...
import { useOpenBookTheme } from "@/lib/openBookTheme";
...
function SelectContent({
  ...
  >) {
  const openBookTheme = useOpenBookTheme();
  return (
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          data-ob-theme={openBookTheme?.theme ?? undefined}
          style={openBookTheme?.customStyle}
